...
# -*- coding: utf-8 -*-
#
# qpx_widgets documentation build configuration file
#
...
_version_py = os.path.join(repo, 'qpx_widgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'qpx_widgetsdoc'
...
latex_documents = [
    (master_doc, 'qpx_widgets.tex', 'qpx_widgets Documentation',
     'me', 'manual'),
]
